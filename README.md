...
By leveraging Soroban smart contracts, AfiaPass transforms every delivery into a verifiable, auditable transaction, reducing friction for riders and ensuring transparency for revenue agencies.
🔑 Quick Summary
...
Contains the "Laws of the Road"—business logic defining when a permit is valid, how long it lasts, and which LGAs are covered.
...
Within TheTwoHorsemen organization, the project is split into three main repositories:
🧭 How AfiaPass Works
